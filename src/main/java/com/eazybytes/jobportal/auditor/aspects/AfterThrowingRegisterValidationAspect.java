...
@Slf4j
public class AfterThrowingRegisterValidationAspect {
    ...
    public void validateBeforeRegister(JoinPoint joinPoint) {
        ...
        Optional<JobPortalUser> existingUser = jobPortalUserRepository.findByEmailOrMobileNumber(request.email(), request.mobileNumber());
